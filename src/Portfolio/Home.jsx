      ...
      <div style={{
        ...
        <div
          ...
          style={{
            ...
            width: avatarSize,
            height: avatarSize,
            /* FIX: reduced float range (-10px instead of -20px) so the
               image never overlaps the 60px navbar on mobile */
            animation: "homeFloat 6s ease-in-out infinite",
            position: "relative",
            cursor: "pointer",
            /* FIX: push avatar down on mobile so the upward float peak
               still stays below the navbar */
