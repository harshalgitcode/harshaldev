  ...
  return (
    <div style={{ background: "#030810", minHeight: "100vh", color: "#c8d8e8", fontFamily: "'Segoe UI', sans-serif", overflowX: "hidden", position: "relative" }}>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        @media (max-width: 768px) {
          ...
          .hero-content { flex-direction: column-reverse !important; align-items: center !important; text-align: center !important; gap: 40px !important; }
          .hero-avatar { position: static !important; transform: none !important; right: auto !important; top: auto !important; width: 220px !important; height: 220px !important; }
          .hero-avatar-inner { width: 220px !important; height: 220px !important; }
          .hero-text { max-width: 100% !important; }
          .hero-buttons { justify-content: center !important; }
          .contact-social { flex-wrap: wrap !important; }
        ...
        @media (max-width: 480px) {
          ...
          .hero-avatar-inner { width: 180px !important; height: 180px !important; }
        }
      `}</style>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, padding: "0 5%", height: "60px", display: "flex", alignItems: "center", justifyContent: "space-between", background: "linear-gradient(180deg, #030810f0, #030810cc)", backdropFilter: "blur(12px)", borderBottom: "1px solid #00d4ff11" }}>
        ...
        {/* Mobile hamburger */}
        <button id="menu-btn" onClick={() => setMenuOpen(o => !o)} style={{ display: "none", background: "none", border: "1px solid #00d4ff33", borderRadius: "6px", padding: "6px 8px", cursor: "pointer", color: "#00d4ff" }}>
          <style>{`@media(max-width:768px){#menu-btn{display:flex!important;align-items:center}}`}</style>
      ...
      {menuOpen && (
        <div id="mobile-menu" style={{ position: "fixed", top: "60px", left: 0, right: 0, zIndex: 999, background: "#030d18f5", backdropFilter: "blur(16px)", borderBottom: "1px solid #00d4ff22", padding: "12px 5% 16px" }}>
          {sections.map(s => (
            <button key={s} onClick={() => scrollTo(s)} style={{ display: "flex", alignItems: "center", gap: "12px", width: "100%", background: "none", border: "none", cursor: "pointer", padding: "12px 0", borderBottom: "1px solid #00d4ff0d" }}>
              <div style={{ width: "20px", height: "1px", background: activeSection === s ? "#00d4ff" : "#334", boxShadow: activeSection === s ? "0 0 6px #00d4ff" : "none" }} />
      ...
      <section id="home" className="section" style={{ display: "flex", alignItems: "center", paddingTop: "60px", minHeight: "100vh" }}>
        ...
        <div className="hero-content" style={{ width: "100%", maxWidth: "1200px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "40px", zIndex: 1 }}>
          {/* Text */}
          <div className="hero-text" style={{ maxWidth: "580px", animation: "fadeInUp 0.8s ease", flex: 1 }}>
          ...
          {/* Avatar */}
          <div className="hero-avatar" style={{ flexShrink: 0, width: "300px", height: "300px", animation: "float 6s ease-in-out infinite", position: "relative" }}>
            ...
            <div style={{ position: "absolute", inset: "10px", borderRadius: "50%", border: "1px solid #00d4ff44", animation: "spin-slow 20s linear infinite" }}>
              {[0, 90, 180, 270].map(angle => (
                <div key={angle} style={{ position: "absolute", width: "8px", height: "8px", borderRadius: "50%", background: "#00d4ff", top: "50%", left: "50%", transform: `rotate(${angle}deg) translateX(135px) translateY(-50%)`, boxShadow: "0 0 10px #00d4ff, 0 0 20px #00d4ff55" }} />
              ))}
            </div>
            <div style={{ position: "absolute", inset: "40px", borderRadius: "50%", border: "1px dashed #bf00ff33", animation: "spin-rev 15s linear infinite" }}>
              {[45, 135, 225, 315].map(angle => (
                <div key={angle} style={{ position: "absolute", width: "5px", height: "5px", borderRadius: "50%", background: "#bf00ff", top: "50%", left: "50%", transform: `rotate(${angle}deg) translateX(105px) translateY(-50%)`, boxShadow: "0 0 8px #bf00ff" }} />
              ))}
            </div>
            <div style={{ position: "absolute", inset: "70px", borderRadius: "50%", border: "2px solid #00d4ff66", boxShadow: "0 0 40px #00d4ff33, inset 0 0 20px #00d4ff08", overflow: "hidden", background: "linear-gradient(135deg, #0a1520, #051020)" }}>
              {/* <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Orbitron', monospace", fontSize: "32px", color: "#00d4ff", fontWeight: 900 }}>H1111</div> */}
      ...
      <section id="about" className="section">
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "28px", marginTop: "50px" }}>
            <GlowCard>
          ...
          <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px", marginTop: "28px" }}>
            ...
            {skillSections.map(({ label, color, items }, si) => (
              <GlowCard key={label} color={color} style={{ padding: "26px 28px" }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
                  {items.map((item, i) => (
                    <span key={item} className="skill-tag" style={{ padding: "8px 16px", border: `1px solid ${color}55`, borderRadius: "6px", fontSize: "12px", color, background: `${color}0d`, fontFamily: "'Share Tech Mono', monospace", letterSpacing: "1px", boxShadow: `0 0 8px ${color}22`, animationDelay: `${(si * 10 + i) * 0.06}s`, position: "relative", overflow: "hidden" }}
      ...
      <section id="projects" className="section">
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div className="projects-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginTop: "50px" }}>
            {projects.map((p, i) => (
              <div key={p.name} className="project-card" style={{ border: `1px solid ${p.color}22`, borderRadius: "12px", padding: "24px", position: "relative", overflow: "hidden", background: `linear-gradient(135deg, ${p.color}06, transparent)`, animation: `fadeInUp 0.6s ease ${i * 0.15}s both`, cursor: "pointer" }}
      ...
      <section id="contact" className="section" style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ maxWidth: "680px", margin: "0 auto", width: "100%", textAlign: "center" }}>
          ...
          <div className="contact-social" style={{ display: "flex", justifyContent: "center", gap: "12px", marginTop: "32px", marginBottom: "24px", flexWrap: "wrap" }}>
            {socialLinks.map(({ Icon, label, href, color }) => (
              <a key={label} href={href} title={label} className="social-btn" style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 18px", border: `1px solid ${color}44`, borderRadius: "8px", color, background: `${color}0d`, textDecoration: "none", fontFamily: "'Share Tech Mono', monospace", fontSize: "12px", letterSpacing: "1px", boxShadow: `0 0 10px ${color}22` }}
