...
//     // Web Dev icon
//     (
//       <svg key="webdev" width="48" height="48" viewBox="0 0 56 56" fill="none">
//         <rect x="4" y="6" width="48" height="34" rx="4" stroke="#00d4ff" strokeWidth="1.5" fill="none" />
//         <line x1="4" y1="16" x2="52" y2="16" stroke="#00d4ff" strokeWidth="1" opacity="0.4" />
//         <circle cx="11" cy="11" r="2.2" fill="#ff6b35" />
//         <circle cx="19" cy="11" r="2.2" fill="#f7df1e" />
...
//     // Digital Art icon
//     (
//       <svg key="art" width="48" height="48" viewBox="0 0 56 56" fill="none">
//         <path d="M10 44 Q14 28 22 22 Q30 16 36 22 Q42 28 36 36 Q30 44 26 42 Q22 40 24 36 Q26 32 30 34" stroke="#ff6b35" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
...
//             fontFamily: "'Share Tech Mono', monospace",
//             boxShadow: hovered ? `0 0 10px ${ac}55` : "none",
//             transition: "box-shadow 0.3s",
//             zIndex: 2,
//           }}>+</div>
//         </div>
...
//           borderRadius: "30px",
//           fontSize: "9px", color: ac,
//           fontFamily: "'Share Tech Mono', monospace", letterSpacing: "2.5px",
//           background: `${ac}0d`, flexShrink: 0,
//           boxShadow: hovered ? `0 0 18px ${ac}44` : "none",
//           transition: "box-shadow 0.3s",
//         }}>
//           <div style={{
//             width: "5px", height: "5px", borderRadius: "50%",
...
//               }} />
//               <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "9px", letterSpacing: "3px", color: group.color, opacity: 0.9 }}>{group.heading}</span>
//               <div style={{ flex: 1, height: "1px", background: `linear-gradient(90deg, ${group.color}55, transparent)` }} />
//             </div>
//             <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
//               {group.items.map((feat, i) => (
//                 <div key={feat} style={{
